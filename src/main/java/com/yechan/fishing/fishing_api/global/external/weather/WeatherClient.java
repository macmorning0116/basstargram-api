...
public class WeatherClient {
  ...
  public WeatherClient(
      @Qualifier("openWeatherWebClient") WebClient webClient, OpenWeatherApiProperties props) {
  ...
  private GptWeatherContext toGptWeatherContext(double lat, double lng, OpenWeatherResponse res) {
    validateResponse(res);
