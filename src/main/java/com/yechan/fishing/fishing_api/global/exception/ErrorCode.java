...
public enum ErrorCode {
  ...
  AUTH_SOCIAL_TOKEN_EXCHANGE_ERROR("AUTH_SOCIAL_TOKEN_EXCHANGE_ERROR", "소셜 토큰 교환 중 에러가 발생했습니다."),
  AUTH_PROVIDER_CONFIGURATION_ERROR("AUTH_PROVIDER_CONFIGURATION_ERROR", "소셜 로그인 설정이 올바르지 않습니다."),
