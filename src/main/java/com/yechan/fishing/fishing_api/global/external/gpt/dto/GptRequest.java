...
public record GptRequest(String model, List<Input> input) {

  public record Input(String role, List<Content> content) {}
  ...
  public record ImageContent(String type, String image_url, String detail) implements Content {}
}
