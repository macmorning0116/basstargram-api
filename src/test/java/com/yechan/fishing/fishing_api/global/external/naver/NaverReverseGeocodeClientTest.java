...
class NaverReverseGeocodeClientTest {
  ...
  void reverseGeocode_returnsExtractedAddress() throws Exception {
    ...
    assertEquals(
        "/map-reversegeocode/v2/gc?coords=126.978,%2037.5665&output=json&orders=legalcode,admcode,addr,roadaddr",
        request.getPath());
  ...
  void reverseGeocode_whenResultsMissing_throwsNaverApiError() {
    ...
    FishingException ex =
        assertThrows(FishingException.class, () -> client.reverseGeocode(37.5665, 126.9780));
