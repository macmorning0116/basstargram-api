...
class WeatherClientTest {
  ...
  void getWeather_returnsMappedResponse() throws Exception {
    ...
    assertEquals(
        "/data/2.5/weather?lat=37.5&lon=127.0&units=metric&appid=test-key", request.getPath());
  ...
  void getWeather_whenApiReturnsError_throwsWeatherApiError() {
    ...
    FishingException ex =
        assertThrows(FishingException.class, () -> weatherClient.getWeather(37.5, 127.0));
