...
class AnalysisServiceTest {
  ...
  void analyze_fetchesWeatherThenDelegatesToGpt() {
    ...
    GptWeatherContext weather =
        new GptWeatherContext(
            37.5, 127.0, 100L, 20.0, 19.0, 50, 2.0, 90, 20, "Clear", "clear sky", 10L, 90L);
    AnalysisResponse response =
        new AnalysisResponse(
            "요약",
            List.of(
                new AnalysisPoint(0.2, 0.3, 0.1, "이유1"), new AnalysisPoint(0.6, 0.7, 0.1, "이유2")),
            "채비",
            "전략");
